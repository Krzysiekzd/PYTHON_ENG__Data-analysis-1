...
for i in gannt_plot_rows:
    ax.broken_barh(gannt_plot_rows[i], (0.5+i*3.5, 3),edgecolor='black', facecolors=colors[i])
...
plt.savefig('gannt_plot_colored.pdf',dpi=200,format='pdf')
plt.savefig('gannt_plot_colored.png')
plt.show()